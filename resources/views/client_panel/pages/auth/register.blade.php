...
<body>
    <form action="{{ route('client_register') }}" method="POST" class="">
        @csrf
            ...
            <div class="rounded-2xl w-full lg:w-96 bg-zinc-600  p-1">
                <div
                    ...
                    <div class="w-full flex flex-col gap-3 py-3">
                        ...
                        @endif
                        <div class="w-full">
                            <p class="text-sm font-semibold py-1 text-slate-600">Enter Full Name</p>
                            <input class="border-2 px-2 py-1 w-full" type="text" name="name"
                        ...
                        <div class="w-full">
                            <p class="text-sm font-semibold py-1 text-slate-600">Enter Email Address</p>
                            <input class="border-2 px-2 py-1 w-full" type="text" name="email"
                        ...
                        <input class="bg-slate-700 text-white mt-2 hover:bg-slate-900 py-1" type="submit"
                            name="login">
                        <p class="text-center">Already have an account? <a class="text-sky-500 hover:underline duration-400" href="{{ route('login') }}" >Login</a></p>
                    </div>
                </div>
            </div>
        </div>
