...
<div class="flex justify-center py-10">
        <div class="w-full px-4 md:px-0 md:w-[60vw]">
            <p class="text-3xl font-bold tracking-wider pb-5 text-red-500">Privacy Policy</p>
            <div class="flex flex-col gap-3 pl-2">
                <p class="font-semibold text-slate-800">tejaselectronics.in recognises the importance of maintaining your privacy.
                    We value your privacy and appreciate your trust in us. This Policy describes how we treat user
                    information we collect on <a class="text-red-500" href="//tejaselectronics.in">https://www.tejaselectronics.in</a> and
                ...
                <p class="font-semibold text-slate-800">tejaselectronics.in is a property of Kamakhya Worldwide Technology Private
            ...
            <div class="flex flex-col gap-3 pl-2">
                <p class="font-semibold text-slate-800"><span class="font-bold">You can opt out of receiving our marketing
                        emails</span>To stop receiving our promotional emails, please email unsubscriber@tejaselectronics.in. It may
            ...
            <div class="flex flex-col gap-3 pl-2">
                ...
                <div class="">
                    ...
                    <p class="font-bold text-slate-800">Email: <a href="mailto:sales@tejaselectronics.in" class="text-red-500">sales@tejaselectronics.in</a></p>
                </div>
                <p class="font-semibold text-slate-800">If you have any questions about this Policy or other privacy
                    concerns, you can also email us at <a href="mailto:care@tejaselectronics.in" class="text-red-500">care@tejaselectronics.in </a></p>
            </div>
