...
<div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        ...
        <div class="flex lg:flex-row flex-wrap  mt-3">
            ...
            <div class="lg:w-3/4 w-full  pe-1 w-full">
                ...
                <div class="flex flex-row border-zinc-300 border-2 rounded-md relative">
                    <div
                        ...
                        <img class="lg:w-60 w-full scale-105" src="https://tejaselectronics.in/img/Air%20Cooler%20image/11.webp" alt="image">
                    </div>
                    <div class="flex flex-col p-3 w-4/5 leading-3 bg-zinc-50 relative lg:h-auto h-40">
                        <div class="w-80 leading-3">
                            <h5 class="font-bold text-xl">WATER GEYSER(6L)</h5>
                            <p class="text-sm uppercase text-zinc-600">Av</p>
                            <p><span class="font-bold">Color:</span>Black</p>
                            <p class="text-2xl  absolute bottom-12 left-2">Rs. 200</p>
                        </div>
                        <div class="flex flex-row justify-between  ">
                            ...
                            <div class="flex flex-row justify-between gap-2 absolute bottom-1 right-2 left-2">
                                ...
                                <span class="px-2 items-center flex justify-center">1</span>
                                <a href="#" class="bg-zinc-700 hover:bg-zinc-900 p-2 flex justify-center items-center duration-300 text-white rounded-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white"
                ...
                <div class="mt-5">
                    <div class="flex lg:flex-row my-2 ps-2">
                        <h5 class="text-lg font-bold inline border-b-2 border-red-500">Related Products</h5>
                    </div>
            ...
            <div class="lg:w-1/4 w-full ps-1">
                <!-- aside price -->
                <div class="flex flex-col bg-zinc-50 p-3 border-2 border-zinc-300 rounded-md">
                    <div class="flex flex-col">
                        <h4 class="flex justify-between item-cneter">Subtotal (1 item): <span>---</span> <b>&#8377; 200</b></h4>
                        <h5 class="flex justify-between item-cneter">Delivery Fee: <span>---</span> <b>&#8377; 150</b></h5>
                        <hr class="my-2 ">
                        <h3 class="flex justify-between item-cneter">Order Total: <span>---</span> <b>&#8377; 200</b></h3>
                    </div>
                ...
                <div class="flex flex-col bg-zinc-100  ">
                    <div class="flex flex-row justify-start font-bold text-sm my-2 ">
                        <h5 class="font-bold text-lg border-red-500 border-b-2 inline">Your like Items</h5>
                    </div>
