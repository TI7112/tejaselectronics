...
<div class="md:px-20">
    <div class="py-5">
        ...
        <div class="flex flex-col-reverse md:flex-row px-4 justify-center gap-10 items-center">
            ...
            <div class="md:w-2/4">
                <img class="rounded-xl " src="{{asset('static/about-us.jpg')}}" alt="">
            </div>
        </div>
    </div>
    <div class="py-5">
        ...
        <div class="flex flex-col md:flex-row justify-center gap-10 items-center px-4">
            <div class="md:w-2/4">
                <img class="rounded-xl" src="{{asset('static/our-mission.jpg')}}" alt="">
            </div>
    ...
    <div class="py-5">
        ...
        <div class="flex flex-col-reverse md:flex-row justify-center gap-10 items-center px-4">
            ...
            <div class="md:w-2/4">
                <img class="rounded-xl" src="{{asset('static/our-team.jpg')}}" alt="">
