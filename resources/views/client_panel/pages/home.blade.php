...
@section('content')
    ...
    <div class="">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 md:px-20 px-4 gap-5">
                ...
                <a href="/category/{{ $value->slug }}">
                    <div class="border-2 border-zinc-600 relative group bg-zinc-300 text-white rounded-xl overflow-hidden">
                        ...
                        <div class="p-2 bg-[rgba(0,0,0,0.6)] absolute bottom-0 w-full flex justify-between items-end">
                            ...
                            <p
                                class="bg-white text-[10px] lg:text-base border-2 font-bold border-white hover:bg-transparent text-zinc-800 hover:text-white px-5 rounded-full">
                                Checkout</p>
                        </div>
                        <p class="text-xs bg-red-500 absolute text-white top-2 right-2 px-3 py-0.5 rounded">NEW</p>
                    </div>
                </a>
            @endforeach
        </div>
    ...
    <div class="">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 md:px-20 px-4 gap-5 pb-10">
    ...
    <div class="flex pt-5 flex-col bg-slate-800 items-center py-16">
        ...
        <div class="flex flex-col items-end gap-2">
            <input type="text" name="email" placeholder="Enter your Email"
                class="outline-none border-2 rounded px-2 py-0.5 w-80 lg:w-96 focus:border-white">
            <button
