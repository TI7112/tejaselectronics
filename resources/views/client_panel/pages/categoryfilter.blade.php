...
@section('content')
    ...
    <div class="bg-white">
                    ...
                    @foreach ($product as $value)
                        <a href="/product/{{ $value->slug }}" class="">
                            <div
                                ...
                                @if ($value->img)
                                    <img class="h-60 w-full duration-500 group-hover:brightness-75"
        ...
        @else
            <div class="flex min-h-[40vh] justify-center items-center w-full">
                <p class="text-center text-3xl font-semibold">No Product Found</p>
            </div>
        @endif
    </div>
